...
export default function Orders() {
    ...
    const { data, error, isLoading } = useSWR<OrdersResponse>('api/orders', fetcher);
  ...
  return (
    <div className="sm:pl-6">
        ...
        <p className='my-10 text-2xl'>
            Here you can see all the orders from your customers
        </p>

        <div>
            {/* {data?.map(order =>(
                <div key={order.id} className="p-5 space-y-2 border-b shadow bg-slate-100">
